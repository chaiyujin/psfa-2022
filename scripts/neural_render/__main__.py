if __name__ == "__main__":
    ...
    npy_file = "runs/anime/m001_trump/animnet-decmp-abl_no_reg/ds16_xfmr-conv_causal-blend50_trainable-seq20-bsz4-BatchSamplerWithDtwPair/generated/[50][test]test-clips/speech@clip0/dump-offsets-final.npy"
    verts = np.load(npy_file) + idle_verts[None]

    reenact_video = "assets/datasets/talk_video/celebtalk/data/m001_trump/avoffset_corrected/vld-000-fps25.mp4"
    ...
    audio_fpath = 'runs/anime/m001_trump/animnet-decmp-abl_no_reg/ds16_xfmr-conv_causal-blend50_trainable-seq20-bsz4-BatchSamplerWithDtwPair/generated/[50][test]test-clips/speech@clip0.wav'
